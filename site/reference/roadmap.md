...
首版规划 58 章，分为八个部分。前两部分共 14 章已经完成正文与项目实现。

| 部分 | 章节 | 当前状态 | 统筹项目 |
| --- | ---: | --- | --- |
| [01 · 起步与 Flutter 所需 Dart](#part-01) | 7 | `verified` | 今日节奏板 |
| [02 · 组件、布局与输入](#part-02) | 7 | `verified` | 小型展览编辑器 |
| [03 · 状态、生命周期与动画](#part-03) | 7 | `not-started` | 植物照护台 |
| [04 · 异步、网络与本地数据](#part-04) | 8 | `not-started` | 城市活动雷达 |
| [05 · 导航、自适应、可访问性与国际化](#part-05) | 7 | `not-started` | 场馆导览册 |
| [06 · 应用架构与生态主方案](#part-06) | 8 | `not-started` | 社区工坊排期台 |
